...
public:
    ...
    double xPos = 0.f, yPos = 0.f;              //Cursor position
    float camPan[2] = { 90.f, 90.f };
    float orthoPos[2] = {0.f};
    glm::vec3 cameraPos = camPosAdjustment;     //Initialize camera position
